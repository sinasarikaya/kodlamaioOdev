...
public class DIDKPSPublicSoap
{
    ...
    public DIDKPSPublicSoap(){}

    public DIDKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public DIDKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        DIDExtendedSoapSerializationEnvelope envelope= new DIDExtendedSoapSerializationEnvelope(DIDExtendedSoapSerializationEnvelope.VER11);
