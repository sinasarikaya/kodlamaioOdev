...
public class DIDExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(DIDDateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new DIDStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static DIDDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static DIDDateTimeConverter dateTimeConverter = new DIDStandardDateTimeConverter();

    public DIDExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public DIDExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new DIDMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=DIDHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,DIDExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=DIDHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
