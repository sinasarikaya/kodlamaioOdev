...
public class OLWKPSPublicSoap
{
    ...
    public OLWKPSPublicSoap(){}

    public OLWKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public OLWKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        OLWExtendedSoapSerializationEnvelope envelope= new OLWExtendedSoapSerializationEnvelope(OLWExtendedSoapSerializationEnvelope.VER11);
