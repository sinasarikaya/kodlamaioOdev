...
public class OLWExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(OLWDateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new OLWStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static OLWDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static OLWDateTimeConverter dateTimeConverter = new OLWStandardDateTimeConverter();

    public OLWExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public OLWExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new OLWMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=OLWHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,OLWExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=OLWHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
